        ...
        <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left h-32 justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                {activeItem.meta && (
                  <span className="text-xs font-medium uppercase tracking-wider text-kingspan-blue">
                    {activeItem.meta}
                  </span>
                )}
                <h2 className="text-3xl font-normal tracking-tight md:text-4xl text-kingspan-navy">
                  {activeItem.title}
                </h2>
                {activeItem.description && (
                  <p className="max-w-md text-kingspan-slate">
                    {activeItem.description}
                  </p>
                )}
              </motion.div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 rounded-full bg-white/80 p-1 ring-1 ring-kingspan-cloud backdrop-blur-md">
              <button
                onClick={handlePrev}
                className="rounded-full p-3 text-kingspan-slate transition hover:bg-kingspan-cloud hover:text-kingspan-blue active:scale-95"
                aria-label="Previous"
              >
                <ChevronLeft className="h-5 w-5" />
              </button>
              <span className="min-w-[40px] text-center text-xs font-mono text-kingspan-slate">
                {activeIndex + 1} / {count}
              </span>
              <button
                onClick={handleNext}
            ...
            {activeItem.href && (
              <a
                ...
                className="group flex items-center gap-2 rounded-full bg-kingspan-blue px-5 py-3 text-sm font-semibold text-white transition-transform hover:scale-105 active:scale-95"
              >
                Explore
