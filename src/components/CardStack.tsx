        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ? "bg-kingspan-navy"
                      : "bg-kingspan-navy/30 hover:bg-kingspan-navy/50",
                  )}
          ...
          {activeItem.href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-kingspan-slate hover:text-kingspan-navy transition"
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-kingspan-cloud text-sm text-kingspan-slate">
            No image
          </div>
        )}
      </div>
